...
#########################################################################################3    
dataframe.to_csv('presentation/CSE4062_Group7_alldataset.csv',index=False)
writer = pd.ExcelWriter('presentation/CSE4062_Group7_alldataset.xlsx')
...
writer = pd.ExcelWriter('presentation/CSE4062_Group7_y.xlsx')
...
writer = pd.ExcelWriter('presentation/CSE4062_Group7_dataset_X.xlsx')
